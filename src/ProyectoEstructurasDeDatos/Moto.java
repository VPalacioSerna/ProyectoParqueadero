...
public class Moto extends Vehiculo {
	...
	public static Moto agregarMoto() {
		...
		do {
			System.out.print(
					"Ingrese la placa de la moto (3 letras, 2 números y 1 letra, solo mayúsculas, ej: ABC12D): ");
			placa = sc.next();
	...
	public String toStringMoto() {
		return color + "," + marca + "," + placa + "," + tiempoInicial + "," + cilindraje + "," + numeroEstacionamiento;
	}
}
