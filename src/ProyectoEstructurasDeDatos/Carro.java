...
public class Carro extends Vehiculo {
	...
	public Carro(String color, String marca, String placa, int tiempoInicial, int numeroDePuertas,
	...
	public String toStringCarro() {
		return color + "," + marca + "," + placa + "," + tiempoInicial + "," + numeroDePuertas + "," + tipoDeVehiculo + ","
